                    ...
                    <div class="card">
                        ...
                        <div class="card-hover">
                            <div class="card-links">
                                ...
                                <a href="#">
                                    <svg class="mk-svg-icon" fill="white" data-name="mk-li-food" data-cacheid="icon-5eabe39c707e5" style=" height:32px; width: 32px; " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
